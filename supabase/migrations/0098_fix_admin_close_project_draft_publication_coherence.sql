-- 0098 — Correctif 0094 : cloturer un projet encore en brouillon (par ex.
-- annuler un projet qui n'a jamais ete lance) echouait sur la contrainte
-- projects_publication_coherence (status <> 'draft' exige published_at
-- non nul). admin_close_project doit, comme admin_set_project_status,
-- renseigner published_at au premier changement de statut hors brouillon.
