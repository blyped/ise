...
export const metadata = { title: frOpportunities.outcome.title };
  ...
  return shell(
    <div className="flex flex-col gap-8">
      ...
      <div className="flex flex-col gap-2">
        <h1 className="text-h1 text-text-primary font-bold">{frOpportunities.outcome.title}</h1>
        <p className="text-body text-text-secondary">{frOpportunities.outcome.subtitle}</p>
      </div>
