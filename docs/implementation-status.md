...
- **Superadmin : le cœur est livré** (`/administration`, migrations 0076 + 0077, harnais 0030 —
  ...
  dans l'écran de détail SA-031, même principe que projets/communautés).**
  Restent sans écran : SA-034→037 (contenus — la partie éditoriale est couverte par le CMS).
...
9. Compléter le chantier **Superadmin** : le cœur (SA-001→020, SA-038→039, SA-011→015, SA-021→022, SA-023→033) est livré. SA-034→037 couverts par l'existant (décision C-07). OPS est abandonné (C-05).
