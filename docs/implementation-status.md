...
| Actualités & événements                           | ISE-092→096            | ✅          | ✅  | ✅ SQL 0011, 0029, 0113, 0117         | ✅ 5/5       | ⬜     | 0 actualité et 0 événement en base ; proposition d'actualité non ouverte (N-i) ; événements et opportunités peuvent désormais porter un visuel de couverture (0113, D-166) ; les actualités aussi depuis 0117 (D-172) — couverture unique réutilisée sur la landing et la page article, plus le réglage `cover_has_text`                                                                                                                          | 🟡     |
